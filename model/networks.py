...
# from model.ddpm_trans_modules.CVDnet2 import CVDNet
from model.ddpm_trans_modules.CVDnet3 import CVDNet
...
def define_G(opt):
    ...
    if model_opt['which_model_G'] == 'ddpm':
        from .ddpm_tmodules import diffusion, unet
    elif model_opt['which_model_G'] == 'sr3':
        from .sr3_modules import diffusion, unet
    elif model_opt['which_model_G'] == 'trans':
        #from .ddpm_trans_modules import diffusion, unet
        from .ddpm_trans_modules import diffusion3, unet5
        # from .ddpm_trans_modules import diffusion3, unet_cnn
       # from .ddpm_trans_modules import diffusion_noGFEM, unet_noGFEM
    ...
    # netG = diffusion3.GaussianDiffusion(
    #     model,
    #     model2,
    #     image_size=model_opt['diffusion']['image_size'],
